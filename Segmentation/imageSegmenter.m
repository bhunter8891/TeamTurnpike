function [ Comps ] = imageSegmenter( imageFile )
...
Comps5 = Connected_Comp_Edges(imageFile);
Comps6 = thinRoad(imageFile);
Comps7 = rgbSeg(imageFile);
%#################################
...
CC.PixelIdxList = [CC.PixelIdxList Comps6.PixelIdxList];
CC.NumObjects = CC.NumObjects + Comps6.NumObjects;
CC.PixelIdxList = [CC.PixelIdxList Comps7.PixelIdxList];
CC.NumObjects = CC.NumObjects + Comps7.NumObjects;
